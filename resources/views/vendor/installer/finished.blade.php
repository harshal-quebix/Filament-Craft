...
@section('container')
    ...
    <p class="text-red"><strong>{{ __('Default User Created') }} : admin@example.com / admin@1232</strong></p>
	@if(is_array(session('message')) && !empty(session('message')['dbOutputLog']))
    ...
    <div class="buttons">
        <a href="{{ route('filament.admin.auth.login') }}" class="button">{{ trans('installer_messages.final.exit') }}</a>
    </div>

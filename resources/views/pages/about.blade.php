    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-8 sm:gap-12 mb-16 sm:mb-20">
            <div class="bg-white p-8 sm:p-10 rounded-3xl shadow-lg">
                <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6 cms-bg-main">
        ...
        <div class="bg-white p-8 sm:p-12 rounded-3xl shadow-lg">
            ...
            <div class="grid md:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="text-center">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 cms-bg-main-20">
                        <svg class="w-8 h-8 sm:w-10 sm:h-10 cms-text-main" fill="currentColor" viewBox="0 0 20 20">

    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-8 sm:space-y-12">
            <section>
                ...
                <div class="grid md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition">
                        <div class="w-14 h-14 sm:w-16 sm:h-16 text-white rounded-2xl flex items-center justify-center font-bold text-xl sm:text-2xl mb-4 sm:mb-6 cms-bg-main">{{ $step['number'] }}</div>
            ...
            <section>
                ...
                <div class="grid md:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center mb-4 cms-bg-main-20">
                            <svg class="w-6 h-6 cms-text-main" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                {!! $fieldType['icon'] !!}
                            </svg>
                        </div>
                ...
                <div class="bg-white p-8 sm:p-10 rounded-2xl shadow-lg border border-gray-100">
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 mr-3 mt-1 flex-shrink-0 cms-text-main" fill="currentColor" viewBox="0 0 20 20">
            ...
            <section>
                ...
                <div class="p-8 sm:p-10 rounded-2xl shadow-lg cms-gradient-bottom-right-fade">
                    <ul class="space-y-3 text-gray-700">
                        @foreach($cmsData['best_practices'] as $practice)
                        <li class="flex items-start">
                            <span class="mr-2 cms-text-main">✓</span>
            ...
            <section class="cms-bg-main text-white p-8 sm:p-12 rounded-3xl shadow-2xl text-center">
                <h2 class="text-3xl font-bold mb-4">{{ __($cmsData['help_title']) }}</h2>
                <p class="text-white/90 mb-8 text-lg">{{ __($cmsData['help_content']) }}</p>
                <a href="{{ route('contact') }}" class="inline-flex items-center bg-white px-8 py-4 rounded-xl hover:shadow-2xl transition font-bold text-lg cms-text-main">
                    {{ __('Contact Support') }}

...
@section('content')
    <div class="w-full max-w-lg px-8 py-16">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-10">
            ...
            @endif
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ __($authData['reset_heading']) }}</h2>
                <p class="text-gray-600 dark:text-gray-300">{{ __($authData['reset_description']) }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ $email }}" readonly
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                </div>

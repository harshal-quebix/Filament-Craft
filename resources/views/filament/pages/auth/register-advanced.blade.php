...
<div class="min-h-screen w-full flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 sm:px-12 lg:px-20 bg-white dark:bg-gray-900">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-3">{{ __($authData['register_heading']) }}</h1>
                <p class="text-gray-500 dark:text-gray-400">{{ __($authData['register_description']) }}</p>
            </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden auth-gradient-bg" style="--theme-color-22: {{ $themeColor }}22; --theme-color-44: {{ $themeColor }}44;">
        ...
        <div class="relative z-10 text-white px-16 max-w-xl">
            ...
            <h2 class="text-4xl font-bold mb-4">{{ __($authData['register_right_heading']) }}</h2>
            <p class="text-lg text-white/90 leading-relaxed">{{ __($authData['register_right_description']) }}</p>
        </div>

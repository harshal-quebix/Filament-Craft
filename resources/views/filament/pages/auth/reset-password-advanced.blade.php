        ...
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" required autofocus class="w-full px-4 py-3 pr-10 border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition" class="auth-input-ring">

            ...
            <form method="POST" action="{{ route('2fa.verify') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="verification_code" name="verification_code" required autofocus
                        ...
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-center text-lg tracking-widest"
